...
import xxt.kareluo.imaging.view.XXTIMGStickerView;

/**
 * Created by felix on 2017/11/15 下午5:44.
 */

public class XXTIMGStickerAdjustHelper implements View.OnTouchListener {

    private static final String TAG = "IMGStickerAdjustHelper";

    private View mView;

    private XXTIMGStickerView mContainer;
    ...
    public XXTIMGStickerAdjustHelper(XXTIMGStickerView container, View view) {
        mView = view;
