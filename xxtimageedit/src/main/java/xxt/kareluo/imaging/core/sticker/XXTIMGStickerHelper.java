package xxt.kareluo.imaging.core.sticker;
...
public class XXTIMGStickerHelper<StickerView extends View & XXTIMGSticker> implements
        XXTIMGStickerPortrait, XXTIMGStickerPortrait.Callback {
    ...
    public XXTIMGStickerHelper(StickerView view) {
        mView = view;
    }
