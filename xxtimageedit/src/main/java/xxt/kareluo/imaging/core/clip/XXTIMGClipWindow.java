package xxt.kareluo.imaging.core.clip;
...
import xxt.kareluo.imaging.core.util.XXTIMGUtils;

/**
 * Created by felix on 2017/11/29 下午5:41.
 */

public class XXTIMGClipWindow implements XXTIMGClip {
    ...
    public void setClipWinSize(float width, float height) {
        ...
        if (!mFrame.isEmpty()) {
            XXTIMGUtils.center(mWinFrame, mFrame);
    ...
    private void reset(float clipWidth, float clipHeight) {
        ...
        XXTIMGUtils.fitCenter(mWinFrame, mFrame, CLIP_MARGIN);
        mTargetFrame.set(mFrame);
    }
    ...
    public boolean homing() {
        ...
        mTargetFrame.set(mFrame);
        XXTIMGUtils.fitCenter(mWinFrame, mTargetFrame, CLIP_MARGIN);
