package xxt.kareluo.imaging.core.util;
...
public class XXTIMGUtils {
    ...
    public static XXTIMGHoming fitHoming(RectF win, RectF frame) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
    ...
    public static XXTIMGHoming fitHoming(RectF win, RectF frame, float centerX, float centerY) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
    ...
    public static XXTIMGHoming fitHoming(RectF win, RectF frame, boolean isJustInner) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
    ...
    public static XXTIMGHoming fillHoming(RectF win, RectF frame) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static XXTIMGHoming fillHoming(RectF win, RectF frame, float pivotX, float pivotY) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
        if (frame.contains(win)) {
            // 不需要Fill
            return dHoming;
    ...
    public static XXTIMGHoming fill(RectF win, RectF frame) {
        XXTIMGHoming dHoming = new XXTIMGHoming(0, 0, 1, 0);
