...
import xxt.kareluo.imaging.core.sticker.XXTIMGStickerAdjustHelper;
import xxt.kareluo.imaging.core.sticker.XXTIMGStickerHelper;
import xxt.kareluo.imaging.core.sticker.XXTIMGStickerMoveHelper;

/**
 * Created by felix on 2017/12/12 下午4:26.
 */

public abstract class XXTIMGStickerView extends ViewGroup implements XXTIMGSticker, View.OnClickListener {
    ...
    private XXTIMGStickerMoveHelper mMoveHelper;

    private XXTIMGStickerHelper<XXTIMGStickerView> mStickerHelper;
    ...
    public XXTIMGStickerView(Context context) {
        this(context, null, 0);
    }

    public XXTIMGStickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXTIMGStickerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onInitialize(Context context) {
        ...
        new XXTIMGStickerAdjustHelper(this, mAdjustView);

        mStickerHelper = new XXTIMGStickerHelper<>(this);
        mMoveHelper = new XXTIMGStickerMoveHelper(this);
    }
