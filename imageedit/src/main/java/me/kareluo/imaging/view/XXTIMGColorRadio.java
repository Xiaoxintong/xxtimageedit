...
public class XXTIMGColorRadio extends RadioButton implements ValueAnimator.AnimatorUpdateListener {

    private static final String TAG = "XXTIMGColorRadio";
    ...
    public XXTIMGColorRadio(Context context) {
        this(context, null, 0);
    }

    public XXTIMGColorRadio(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public XXTIMGColorRadio(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XXTIMGColorRadio);

        mColor = a.getColor(R.styleable.XXTIMGColorRadio_image_color, Color.RED);
        mStrokeColor = a.getColor(R.styleable.XXTIMGColorRadio_image_stroke_color, Color.WHITE);
